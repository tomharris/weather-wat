...
module Digest
  class << self
    # source:///usr/local/lib/ruby/3.1.0/digest.rb:22
...
class Digest::Class
  ...
  class << self
    ...
    # feeds.
    #
    # source:///usr/local/lib/ruby/3.1.0/digest.rb:55
    ...
    #
    # source:///usr/local/lib/ruby/3.1.0/digest.rb:48
...
module Digest::Instance
  ...
  #
  # source:///usr/local/lib/ruby/3.1.0/digest.rb:82
  def base64digest(str = T.unsafe(nil)); end

  # Returns the resulting hash value and resets the digest to the
  # initial state.
  #
  # source:///usr/local/lib/ruby/3.1.0/digest.rb:88
  def base64digest!; end

  # Updates the digest with the contents of a given file _name_ and
  # returns self.
  #
  # source:///usr/local/lib/ruby/3.1.0/digest.rb:63
  def file(name); end
end
...
class Digest::SHA2 < ::Digest::Class
  ...
  #
  # source:///usr/local/lib/ruby/3.1.0/digest/sha2.rb:61
  ...
  #
  # source:///usr/local/lib/ruby/3.1.0/digest/sha2.rb:89
  def <<(str); end
  ...
  #   # => 1024
  #
  # source:///usr/local/lib/ruby/3.1.0/digest/sha2.rb:112
  ...
  # (256 bits) in size.
  #
  # source:///usr/local/lib/ruby/3.1.0/digest/sha2.rb:130
  def digest_length; end

  # source:///usr/local/lib/ruby/3.1.0/digest/sha2.rb:138
  def inspect; end
  ...
  #
  # source:///usr/local/lib/ruby/3.1.0/digest/sha2.rb:79
  def reset; end
  ...
  # source:///usr/local/lib/ruby/3.1.0/digest/sha2.rb:95
  def finish; end

  # source:///usr/local/lib/ruby/3.1.0/digest/sha2.rb:134
  def initialize_copy(other); end
end

# source:///usr/local/lib/ruby/3.1.0/digest/version.rb:4
